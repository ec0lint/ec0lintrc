...
const debug = debugOrig("ec0lintrc:ignore-pattern");
...
const DotPatterns = Object.freeze([".*", "!.ec0lintrc.*", "!../"]);
...
class IgnorePattern {
    ...
    constructor(patterns, basePath) {
         ...
         *
         * It's set `true` for `.ec0lintignore`, `package.json`, and `--ignore-path` for backward compatibility.
